...
public class FirstNonRepeating {
    public static void main(String[] args) {
        ...
        for(int i=0;i<str.length();i++){
            ...
            if(arr[ascii]==1){
                System.out.println(str.charAt(i)+" is the first non-repeating character in given string");
                return;
            }
        }
        System.out.println("The given string doesn't contain any non-repeating character");
    }
}
